...
(function (global) {
	...
	const ARCHETYPES = [
		...
		{ name: "Heliocentric Guard", min: 0, max: 44, w: 0.6, o: { pss: 18, drb: 18, oiq: 16, fg: 10, endu: 8, diq: -16, reb: -12, ins: -10, stre: -6 } },
		...
		{ name: "Pass-First Sparkplug", min: 0, max: 42, w: 0.7, o: { pss: 24, spd: 12, oiq: 10, drb: 8, tp: -8, ins: -14, dnk: -10, reb: -10 } },
		...
		{ name: "Post-Up Guard", min: 30, max: 52, w: 0.5, o: { stre: 16, ins: 14, ft: 8, oiq: 8, spd: -10, tp: -10, drb: -6, jmp: -6 } },
		{ name: "Free-Throw Merchant", min: 0, max: 54, w: 0.6, o: { ft: 18, drb: 12, oiq: 10, spd: 6, ins: 6, tp: -10, diq: -12, reb: -8 } },
		// --- wings --------------------------------------------------------
		...
		{ name: "Wing Sniper", min: 40, max: 70, o: { tp: 22, ft: 14, oiq: 6, drb: -8, ins: -12, dnk: -8, stre: -6, pss: -6 } },
		{ name: "Shot-Creating Wing", min: 40, max: 72, o: { fg: 16, drb: 12, tp: 8, oiq: 8, diq: -10, reb: -8, ins: -6, pss: -4 } },
		{ name: "Transition Wing", min: 38, max: 70, o: { spd: 16, dnk: 14, endu: 10, jmp: 8, tp: -10, fg: -8, ft: -6, ins: -6 } },
		{ name: "Cutter / Finisher", min: 40, max: 72, o: { dnk: 18, jmp: 12, oiq: 10, endu: 6, tp: -12, drb: -10, pss: -8, fg: -4 } },
		{ name: "Wing Stopper", min: 42, max: 74, o: { diq: 22, stre: 10, endu: 10, spd: 6, fg: -10, tp: -8, pss: -8, ins: -8 } },
		{ name: "Rebounding Wing", min: 42, max: 74, w: 0.8, o: { reb: 18, jmp: 10, stre: 10, endu: 8, tp: -10, pss: -10, drb: -8, ft: -6 } },
		{ name: "Corner Specialist", min: 38, max: 68, w: 0.8, o: { tp: 18, diq: 8, oiq: 8, drb: -12, pss: -10, ins: -10, fg: -4 } },
		{ name: "Midrange Operator", min: 40, max: 72, w: 0.7, o: { fg: 22, ft: 10, oiq: 8, tp: -12, dnk: -8, reb: -6, pss: -6 } },
		{ name: "Jumbo Playmaker", min: 46, max: 74, w: 0.6, o: { pss: 18, drb: 16, oiq: 12, fg: 6, diq: -10, reb: -8, ins: -8, jmp: -6 } },
		{ name: "Energy Wing", min: 38, max: 70, o: { endu: 14, spd: 10, jmp: 10, reb: 8, diq: 6, tp: -10, fg: -10, pss: -8, ft: -6 } },
		{ name: "Do-It-All Forward", min: 44, max: 76, w: 0.8, o: { oiq: 10, pss: 8, reb: 8, diq: 8, fg: 4, tp: -6, dnk: -6, ins: -6 } },
		{ name: "Bully Slasher", min: 42, max: 72, w: 0.7, o: { stre: 16, dnk: 14, ins: 10, ft: 6, tp: -14, fg: -8, pss: -8, drb: -4 } },
		{ name: "Glide Athlete", min: 40, max: 72, w: 0.7, o: { jmp: 20, spd: 14, dnk: 12, tp: -10, ft: -10, oiq: -10, pss: -8, ins: -4 } },
		// --- everyone -----------------------------------------------------
		...
		{ name: "High-IQ Connector", min: 0, max: 100, w: 0.8, o: { oiq: 16, pss: 12, diq: 8, tp: 4, dnk: -10, jmp: -8, ins: -8, fg: -4 } },
		{ name: "Raw Project", min: 0, max: 100, w: 0.6, o: { jmp: 14, spd: 10, stre: 10, endu: 6, oiq: -14, diq: -10, ft: -10, tp: -8, fg: -6 } },
		{ name: "Iron Man", min: 0, max: 100, w: 0.6, o: { endu: 20, stre: 8, diq: 6, oiq: 6, dnk: -8, tp: -6, ins: -8, jmp: -6 } },
		// --- bigs ---------------------------------------------------------
		...
		{ name: "Point Center", min: 60, max: 100, w: 0.5, o: { pss: 22, oiq: 16, drb: 10, ft: 6, dnk: -10, jmp: -8, diq: -8, tp: -6 } },
		...
		{ name: "Undersized Rebounder", min: 46, max: 62, w: 0.6, o: { reb: 20, stre: 14, endu: 10, diq: 6, tp: -10, fg: -8, drb: -8, pss: -6 } },
		{ name: "Foul-Prone Enforcer", min: 54, max: 100, w: 0.5, o: { stre: 18, diq: 10, ins: 8, reb: 8, oiq: -14, ft: -10, spd: -8, tp: -8 } },
